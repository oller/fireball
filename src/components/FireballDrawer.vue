  ...
  >
    ...
    <div class="content">
      <div class="m-b-lg">
        ...
        <p>A chart displaying all the recorded fireballs and bolides events from NASA's API.</p>
        <p>
          A
          log scale is applied to the radius calculation due to the massive
          <a
            href="https://en.wikipedia.org/wiki/Chelyabinsk_event"
            target="new"
          >Chelyabinsk Event</a>
          being such an extreme outlier in terms of energy radiated. (That's the big fella close to the Russia / Kazakhstan border).
          <a
    ...
    <h4 class="has-text-weight-bold has-text-white m-b-sm">Scrub by date range</h4>
    <fireball-slider :is-visible="showDrawer" :dateRange="fireballYearRange" class="m-b-xl"></fireball-slider>
    <h4 class="has-text-weight-bold has-text-white m-b-sm">Display energy for</h4>
